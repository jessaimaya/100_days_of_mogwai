...
impl Default for Login {
    fn default() -> Self {
        Login {
            ...
            slides: vec![
                Slide {
                    text: "Plan your activities and control your progress online.".to_string(),
                    image: "/login/rocket.png".to_string(),
                },
                Slide {
                    text: "Mogwai is awesome! I'd be lost without Mogwai.".to_string(),
                    image: "/login/constellation.png".to_string(),
                },
                Slide {
                    text: "I don't always clop, but when I do, it's because of Mogwai".to_string(),
                    image: "/login/planet.png".to_string(),
                },
            ],
        }
    }
